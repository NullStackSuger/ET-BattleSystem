    ...
    public class CreatLSFCmdEditor : OdinMenuEditorWindow
    {
        ...
        public class LSFCmdItem
        {
            ...
            public void Apply()
            {
                ...
                str.AppendLine("        }");
                str.AppendLine();
                str.AppendLine($"        public override void Receive(Unit unit, {this.ConnectComponent} component, LSF{this.Name}Cmd cmd)");
                str.AppendLine("        {");
                str.AppendLine();
                str.AppendLine("        }");
                str.AppendLine("    }");
                ...
                str.AppendLine();
                str.AppendLine("        }");
                str.AppendLine($"        public override LSFCmd TickEnd(GameRoomComponent room, {this.ConnectComponent} component, bool inRollBack)");
                str.AppendLine("        {");
                str.AppendLine("            return null;");
                str.AppendLine("        }");
                str.AppendLine();
                str.AppendLine($"        public override void Receive(Unit unit, {this.ConnectComponent} component, LSF{this.Name}Cmd cmd)");
                str.AppendLine("        {");
                str.AppendLine();
                str.AppendLine("        }");
                str.AppendLine($"        public override bool Check(LSF{this.Name}Cmd clientCmd, LSF{this.Name}Cmd serverCmd)");
                str.AppendLine("        {");
